...
// 생성용 폼 Props
interface CreateWeddingInfoFormProps {
  onUpdate: (data: CreateWeddingInfoRequest) => void;
  isSubmitting?: boolean;
}

// 수정용 폼 Props
interface UpdateWeddingInfoFormProps {
  data: WeddingInfo;
  onUpdate: (data: UpdateWeddingInfoRequest) => void;
  isSubmitting?: boolean;
}

// 생성용 폼 컴포넌트
export function CreateWeddingInfoForm({
  onUpdate,
  isSubmitting = false,
}: CreateWeddingInfoFormProps) {
  const {
    register,
    handleSubmit,
    formState: { errors },
...
// 수정용 폼 컴포넌트
export function UpdateWeddingInfoForm({
  data,
  onUpdate,
  isSubmitting = false,
}: UpdateWeddingInfoFormProps) {
  const {
    register,
    handleSubmit,
    formState: { errors },
...
// 기존 WeddingInfoForm은 CreateWeddingInfoForm으로 대체 (하위 호환성)
export const WeddingInfoForm = CreateWeddingInfoForm;
