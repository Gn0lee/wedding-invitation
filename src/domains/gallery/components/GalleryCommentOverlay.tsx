        ...
        <div className="relative pr-5">
          <div
            className={`overflow-hidden transition-all duration-300 ease-in-out ${
              isCommentsExpanded ? 'max-h-32' : 'max-h-4'
            }`}
          >
            <div
              ...
              {item.brideComment && (
                <div className="transition-all duration-300">
                  <div className="flex items-start gap-2 text-xs">
                    ...
                    <ul
                      className={`list-inside list-none space-y-1 ${isCommentsExpanded ? '' : 'line-clamp-1'}`}
                    >
          ...
          <CollapsibleTrigger asChild>
            <button className="absolute bottom-0 right-0 text-sm text-gray-50 transition-transform duration-100 hover:scale-110 active:scale-90">
